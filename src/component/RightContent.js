    ...
    return (
        <div className="RightContent" data-aos='fade-up'>
            <div className='About'>
                ...
                <p>I'm a <span id="bold-text">third year computer science student</span> at <span id="bold-text">York University</span>. Currently, I'm doing an internship at <span id="bold-text">CaseWare</span> as a <span id="bold-text">Software Developer in Test</span>.
                </p>
